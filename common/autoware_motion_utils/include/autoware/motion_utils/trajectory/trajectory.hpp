 ...
 */
template <class T>
std::vector<double> calc_curvature(const T & points)
{
...
extern template std::vector<double>
calc_curvature<std::vector<autoware_planning_msgs::msg::PathPoint>>(
  const std::vector<autoware_planning_msgs::msg::PathPoint> & points);
extern template std::vector<double>
calc_curvature<std::vector<autoware_internal_planning_msgs::msg::PathPointWithLaneId>>(
  const std::vector<autoware_internal_planning_msgs::msg::PathPointWithLaneId> & points);
extern template std::vector<double>
calc_curvature<std::vector<autoware_planning_msgs::msg::TrajectoryPoint>>(
  const std::vector<autoware_planning_msgs::msg::TrajectoryPoint> & points);
 ...
 */
template <class T>
std::vector<std::pair<double, std::pair<double, double>>> calc_curvatureAndSegmentLength(
  const T & points)
{
